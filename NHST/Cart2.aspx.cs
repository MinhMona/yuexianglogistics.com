                        ...
                        if (ors != null)
                        {
                            if (ors.Count > 0)
                            {
                                ...
                                foreach (var item in ors)
                                {
                                    ...
                                    html += "           <tr>";
                                    html += "               <td><span style=\"background:#eb5d39;color:#fff; padding:5px 12px; border-radius:50%;\">" + i + "</span></td>";
                                    html += "               <td class=\"img\" style=\"width:30%;\">";
                                    html += "                   <div class=\"thumb-product\">";
                                    html += "                       <div class=\"pd-img\" style=\"width:100%;float:left;margin:5px 0;text-align:center\"><img style=\"width:35%;\" src=\"" + image + "\" alt=\"\"></div>";
                                    html += "                       <div class=\"info\" style=\"clear:both;float:left\"><a href=\"" + linkproduct + "\" target=\"_blank\">" + productname + "</a></div>";
                                    html += "                       <div class=\"info\" style=\"clear:both;float:left;width:100%;margin-top:10px;\">" + item.property + "</div>";
                                    html += "                   </div>";
                                    ...
                                    html += "               <td class=\"total\" style=\"width:5%;\"><p class=\"\"><a href=\"javascript:;\" onclick=\"deleteordertemp('" + ID + "','" + shop.ID + "')\"><i class=\"fa fa-trash\"></i></a></td>";
                                    html += "           </tr>";
