<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMaster.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="NHST.Cart" %>
                ...
                <div class="sec table-price-sec">
                    ...
                    <%--<div class="table-panel">
                        <div class="table-panel-header">
                            <h4 class="title">Title demo</h4>
                            <div class="delivery-opt">
                                <label>
                                    <input type="checkbox" name="delivery_opt_1"><span class="ip-avata"></span> <span class="ip-label">Chuyển thẳng</span></label>
                                <label>
                                    <input type="checkbox" name="delivery_opt_1" checked><span class="ip-avata"></span> <span class="ip-label">Chuyển phát nhanh</span></label>
                                <label>
                                    <input type="checkbox" name="delivery_opt_1"><span class="ip-avata"></span> <span class="ip-label">Kiểm hàng</span></label>
                                <label>
                                    <input type="checkbox" name="delivery_opt_1"><span class="ip-avata"></span> <span class="ip-label">Đóng gỗ</span></label>
                            </div>
                        </div>
                        <div class="table-panel-main">
                            <table>
                                <tr>
                                    <th class="check">
                                        <label class="checklb">
                                            <input type="checkbox"><span class="ip-avata"></span></label></th>
                                ...
                                <tr>
                                    <td class="check">
                                        <label class="checklb">
                                            <input type="checkbox"><span class="ip-avata"></span></label></td>
                                    <td class="img">
                                        <div class="thumb-product">
                                            <div class="pd-img">
                                                <img src="http://antien.vn/temp/-uploaded-tai%20nghe_tai-nghe-khong-day-bluetooth-beats-studio-wireless-gia-re-L7_thumb_1200x1200.jpg" alt="">
                                            </div>
                                            <div class="info">
                                ...
                                <tr>
                                    <td colspan="5" class="note-td">
                                        <textarea class="form-control note" placeholder="Chú thích đơn hàng"></textarea>
                                    </td>
                                </tr>
                                <tr class="hover-tr">
                        ...
                        <div class="table-panel-total">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><strong class="hl-txt">20.250.000 đ</strong></td>
                                </tr>
                            </table>
                            ...
                            <div class="btn-wrap">
                                <a href="#" class="pill-btn btn order-btn">ĐẶT HÀNG</a>
                            </div>
                        </div>
                    </div>--%>
