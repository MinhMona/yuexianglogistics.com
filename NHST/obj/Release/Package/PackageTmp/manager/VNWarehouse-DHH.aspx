            ...
            <div class="list-staff col s12 section">
                <div class="list-table card-panel">
                    ...
                    <div class="count-small" style="margin-top: 20px;">
                        <label style="font-size: 18px; font-weight: bold;">Số lượng kiện đã scan: <span id="txtTotalScan">0</span></label>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        if (msg.d != "none") {
                            ...
                            alert('Không tìm thấy thông tin hoặc kiện đã gửi yêu cầu xuất kho. Vui lòng kiểm tra lại.');
                            obj.val("");
                        }
                    },
