<%@ Page Language="C#" Title="Thêm menu" AutoEventWireup="true" MasterPageFile="~/manager/adminMasterNew.Master" CodeBehind="AddMenu.aspx.cs" Inherits="NHST.manager.AddMenu" %>
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Thêm menu</h4>
                    ...
                    <div class="col s12">
                        <div class="row pb-2 border-bottom-1 ">
                            <div class="input-field col s12">
                                <asp:TextBox runat="server" ID="txtParentName" type="text" class="validate" value="" disabled></asp:TextBox>
                                <label for="rp_username">Menu cha</label>
                            </div>
                            <div class="input-field col s12">
                        ...
                        <div class="row section mt-2">
                            <div class="col s12">
                                <asp:Button ID="btnSave" runat="server" Text="Tạo" CssClass="btn" OnClick="btnSave_Click" />
                            </div>
                        </div>
                    </div>
                </div>
