<%@ Page Title="Danh sách kho đến" Language="C#" MasterPageFile="~/manager/adminMasterNew.Master" AutoEventWireup="true" CodeBehind="warehouse-to-list.aspx.cs" Inherits="NHST.manager.warehouse_to_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">DANH SÁCH KHO ĐẾN</h4>
                    <div class="right-action">
                        <a href="#modalAdd" class="tooltipped modal-trigger btn" data-position="top" data-tooltip="Thêm kho đến">Thêm kho đến</a>
                    </div>
                </div>
            </div>
    ...
    <div id="modalAdd" class="modal modal-fixed-footer" style="height: auto">
        <div class="modal-hd">
            ...
            <h4 class="no-margin center-align">THÊM KHO ĐẾN</h4>
        </div>
        <div class="modal-bd">
            <div class="row">
                ...
                <div class="input-field col s12 m6">
                    <asp:TextBox runat="server" ID="txtAddFee" type="text" class="validate" data-type="text-only"></asp:TextBox>
        ...
        <div class="modal-ft">
            <div class="ft-wrap center-align">
                <asp:Button ID="btnCreate" OnClick="btnSave_Click" runat="server" UseSubmitBehavior="false" class="white-text btn  mr-2" Text="Thêm"></asp:Button>
    ...
    <script>
        ...
        function EditFunction(ID) {
            $.ajax({
                type: "POST",
                url: "/manager/warehouse-to-list.aspx/loadinfo",
                data: '{ID: "' + ID + '"}',
