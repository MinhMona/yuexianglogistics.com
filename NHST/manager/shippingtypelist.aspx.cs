...
namespace NHST.manager
{
    public partial class shippingtypelist : System.Web.UI.Page
    {
        ...
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            if (ac.RoleID == 0)
            {
                ShippingTypeToWareHouseController.Insert(txtAddShipName.Text, txtAddShipDescrtiption.Text, Convert.ToBoolean(hdfAddIsHidden.Value.ToString().ToInt(0)), DateTime.Now, Username);
