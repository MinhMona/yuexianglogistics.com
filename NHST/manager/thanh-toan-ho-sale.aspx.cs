...
{
    public partial class thanh_toan_ho_sale : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            if (ac != null)
            {
                ...
                int total = PayhelpController.GetTotalForSale(ac.ID, status, fd, td, search, stype);
                var la = PayhelpController.GetListSQLForSale(ac.ID, page, 10, status, fd, td, sort, search, stype);
                pagingall(la, total);
            }
        }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("thanh-toan-ho-sale?stype=" + stype + "&s=" + searchname + "&fd =" + fd + "&sort=" + SortType + "&td=" + td + "&st=" + status1);
        }
        #region Pagging
