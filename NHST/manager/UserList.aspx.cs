        ...
        public void pagingall(List<View_UserList> acs, int total)
        {
            ...
            if (total > 0)
            {
                ...
                for (int i = 0; i < acs.Count; i++)
                {
                    ...
                    hcm.Append(" data-tooltip=\"Đơn hàng mua hộ\"><span class=\"list-order\"></span></a>");

                    hcm.Append("<a href=\"Trans-User?uid=" + item.ID + "\" class=\"tooltipped\" data-position=\"top\"");
                    hcm.Append(" data-tooltip=\"Đơn hàng vận chuyển\"><span class=\"list-order\"></span></a>");
