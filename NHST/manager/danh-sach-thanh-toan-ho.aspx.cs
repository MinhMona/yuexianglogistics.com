...
namespace NHST.manager
{
    public partial class danh_sach_thanh_toan_ho1 : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            int total = PayhelpController.GetTotalPage(search, stype, status1, fd, td);
            var la = PayhelpController.GetByUserInSQLHelper_nottextnottypeWithstatus(page, 10, search, status1, stype, fd, td, sort);
            pagingall(la, total);
        }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("danh-sach-thanh-toan-ho?stype=" + stype + "&s=" + searchname + "&fd=" + fd + "&sort=" + SortType + "&td=" + td + "&st=" + status1);
            }
        }
        #region Pagging
