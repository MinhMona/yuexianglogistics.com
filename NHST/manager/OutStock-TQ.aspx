<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutStock-TQ.aspx.cs" MasterPageFile="~/manager/adminMasterNew.Master" Inherits="NHST.manager.OutStock_TQ" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">Xuất kho Trung Quốc</h4>
                </div>
            </div>
    ...
    <script type="text/javascript">
                                                ...
                                                if (isExist == false) {
                                                    ...
                                                    if (check == false) {
                                                        ...
                                                        if (status == 0) {
                                                            ...
                                                            html += "               <option value=\"5\" selected>Đang về kho Việt Nam</option>";
                                                        }
                                                        else if (status == 2) {
                                                            html += "               <option value=\"5\" selected>Đang về kho Việt Nam</option>";
                                                        }
                                                        ...
                                                        html += "<a href=\"javascript:;\" onclick=\"updateWeightNew('" + data.BarCode + "',$(this)," + packageID + ")\" class=\"tooltipped updatebutton\" data-position=\"top\" data-tooltip=\"Xuất kho Trung Quốc\"><i class=\"material-icons\">sync</i></a>";
        ...
        function updateWeightNew(barcode, obj, packageID) {
            ...
            $.ajax({
                type: "POST",
                url: "/manager/OutStock-TQ.aspx/UpdateQuantityNew",
