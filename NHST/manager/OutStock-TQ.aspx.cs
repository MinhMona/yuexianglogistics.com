...
{
    public partial class OutStock_TQ : System.Web.UI.Page
    {
            ...
            string packageadditionfeeVND, string packageSensorCYN, string packageSensorVND)
        {
            ...
            if (package != null)
            {
                SmallPackageController.UpdateStatus(package.ID, 5, currentDate, username_current);
                ...
                if (transportation != null)
                {
                    ...
                    TransportationOrderNewController.UpdateStatus(tID, 7, currentDate, username_current);
                ...
                if (mainorder != null)
                {
                    ...
                    MainOrderController.UpdateStatusOutTQ(mID, 4, currentDate);
                }
                ...
                if (bID > 0)
                {
                    ...
                    if (big != null)
                    {
                        ...
                        if (smalls.Count > 0)
                        {
                            ...
                            if (checkIschua == false)
                            {
                                BigPackageController.UpdateStatus(bID, 5, currentDate, username_current);
                            }
                        }
                        ...
                        if (list.Count > 0)
                        {
                            SuperPackageController.UpdateStatus(Convert.ToInt32(big.SuperPackageID), 2, currentDate, username_current);
                        }
                    }
                }
                return "1";
