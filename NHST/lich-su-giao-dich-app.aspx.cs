...
namespace NHST
{
    public partial class lich_su_giao_dich_app : System.Web.UI.Page
    {
            ...
            if (UID > 0)
            {
                ...
                if (tk != null)
                {
                    ...
                    if (user != null)
                    {
                        ...
                        ltrAccount.Text = string.Format("{0:N0}", user.Wallet) + " vnđ";
        ...
        public void pagingall(List<tbl_HistoryPayWallet> acs)
        {
            ...
            if (acs.Count > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    ...
                    html.Append("  <p class=\"do-txt\">" + symbol + " " + string.Format("{0:N0}", amount) + " VNĐ </p>");
                    html.Append("  </div>");
                    html.Append(" <div class=\"flex-justify-space\">");
                    ...
                    html.Append("   <p class=\"\">" + string.Format("{0:N0}", moneyleft) + " VNĐ </p>");
                    html.Append("  </div>");
                    html.Append("   <div class=\"flex-justify-space\">");
                    html.Append("  <p class=\"gray-txt\">Loại giao dịch:</p>");
                    html.Append("   <p class=\"\">" + PJUtils.GetTradeType(Convert.ToInt32(item.TradeType)) + "</p>");
                    html.Append(" </div>");
                    html.Append(" <div class=\"flex-justify-space\">");
                    html.Append("  <p class=\"gray-txt\">Nội dung:</p>");
                    html.Append("   <p class=\"\">" + item.HContent + "</p>");
                    html.Append("  </div>");
                    html.Append(" </li>");
                }
