...
namespace NHST
{
    public partial class YuxiangMaster : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            ...
            if (confi != null)
            {
                ...
                ltrHotPhone.Text = "HOTLINE: <span class=\"text-number\">"+hotline+"</span> ";
                ...
                //ltrTygia.Text += "<p class=\"text-intro\">Tỉ giá: <span class=\"color-red\"> 1¥ = " + string.Format("{0:N0}", Convert.ToDouble(confi.Currency)) + " </span></p>";
                ...
                ltrSocial.Text += "<li><a href=\"" + confi.Facebook + "\" target=\"_blank\"><i class=\"fab fa-facebook\" aria-hidden=\"true\"></i></a></li>";
                ltrSocial.Text += "<li><a href=\"" + confi.Twitter + "\" target=\"_blank\"><i class=\"fab fa-tiktok\" aria-hidden=\"true\"></i></a></li>";
                ltrSocial.Text += "<li><a href=\"" + confi.YoutubeLink + "\" target=\"_blank\"><i class=\"fab fa-youtube\" aria-hidden=\"true\"></i></a></li>";
                ltrSocial.Text += "<li><a href=\"" + confi.Instagram + "\" target=\"_blank\"><i class=\"fab fa-instagram\" aria-hidden=\"true\"></i></a></li>";

                ltrSocialFT.Text += "<li><a href=\"" + confi.Facebook + "\" target=\"_blank\"><i class=\"fab fa-facebook\" aria-hidden=\"true\"></i></a></li>";
                ltrSocialFT.Text += "<li><a href=\"" + confi.Twitter + "\" target=\"_blank\"><i class=\"fab fa-tiktok\" aria-hidden=\"true\"></i></a></li>";
                ltrSocialFT.Text += "<li><a href=\"" + confi.YoutubeLink + "\" target=\"_blank\"><i class=\"fab fa-youtube\" aria-hidden=\"true\"></i></a></li>";
                ltrSocialFT.Text += "<li><a href=\"" + confi.Instagram + "\" target=\"_blank\"><i class=\"fab fa-instagram\" aria-hidden=\"true\"></i></a></li>";
